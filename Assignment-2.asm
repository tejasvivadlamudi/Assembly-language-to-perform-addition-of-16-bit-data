...
var1 dw 1234h ;First 16-bit number
var2 dw 5678h ;Second 16-bit number

start:
    mov ax, var1 ;Load the first 16-bit number into AX
    add ax, var2 ;Add the second 16-bit number to AX
